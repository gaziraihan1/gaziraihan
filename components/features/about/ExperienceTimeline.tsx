    ...
    <section>
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          <Briefcase size={24} className="w-6 h-6 text-indigo-400" />
        ...
        <div className="space-y-12">
          {experience.map((job, index) => (
            ...
            >
              ...
              <div
                className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"} pl-8 md:pl-0`}
              >
                <motion.div
                ...
                >
                  ...
                  <div
                    className={`flex flex-wrap gap-3 mb-4 text-sm ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}
                  >
                  ...
                  {job.technologies.length > 0 && (
                    <div
                      className={`flex flex-wrap gap-2 mt-4 ${index % 2 === 0 ? "md:flex-row-reverse" : ""}`}
                    >
